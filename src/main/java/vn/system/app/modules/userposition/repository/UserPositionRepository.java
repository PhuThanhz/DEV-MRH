...
public interface UserPositionRepository
        ...
        List<UserPosition> findByUser_IdAndActiveTrue(String userId);

        // ── COMPANY ──────────────────────────────────────────────────────────────
        boolean existsByUser_IdAndCompanyJobTitle_IdAndActiveTrue(String userId, Long companyJobTitleId);

        Optional<UserPosition> findByUser_IdAndCompanyJobTitle_IdAndActiveFalse(
                        String userId, Long companyJobTitleId);

        // ── DEPARTMENT ────────────────────────────────────────────────────────────
        boolean existsByUser_IdAndDepartmentJobTitle_IdAndActiveTrue(String userId, Long departmentJobTitleId);

        Optional<UserPosition> findByUser_IdAndDepartmentJobTitle_IdAndActiveTrue(
                        String userId, Long departmentJobTitleId);

        Optional<UserPosition> findByUser_IdAndDepartmentJobTitle_IdAndActiveFalse(
                        String userId, Long departmentJobTitleId);

        // ── SECTION ───────────────────────────────────────────────────────────────
        boolean existsByUser_IdAndSectionJobTitle_IdAndActiveTrue(String userId, Long sectionJobTitleId);

        Optional<UserPosition> findByUser_IdAndSectionJobTitle_IdAndActiveFalse(
                        String userId, Long sectionJobTitleId);

        // ── MISC ──────────────────────────────────────────────────────────────────
        Optional<UserPosition> findByUser_IdAndSourceAndActiveTrue(String userId, String source);
