...
public class SalaryStructureController {
    ...
    // ← THÊM MỚI
    @GetMapping("/departments/{departmentId}/salary-matrix/my")
    @ApiMessage("Bảng khung lương của tôi trong phòng ban")
    public ResponseEntity<?> getMyMatrix(@PathVariable Long departmentId) {
        return ResponseEntity.ok(matrixService.getMyDepartmentSalaryMatrix(departmentId));
    }
