...
public interface DepartmentSalaryGradeRepository
        ...
        boolean existsByDepartmentJobTitleIdAndGradeLevel(
                        Long departmentJobTitleId, Integer gradeLevel);
        ...
        // Dùng cho SalaryMatrix + fetchByMyCompany
        List<DepartmentSalaryGrade> findByDepartmentJobTitleIdIn(List<Long> ids);

        // Dùng cho fetchMy (active only)
        List<DepartmentSalaryGrade> findByDepartmentJobTitleIdInAndActiveTrue(List<Long> ids);
}